...
| Name | Summary |
|---|---|
| [MessageSource](../-message-source/index.md) | 消息源. 消息源存在于 [MessageChain](../-message-chain/index.md) 中, 用于表示这个消息的来源, 也可以用来分辨 [MessageChain](../-message-chain/index.md).`sealed class MessageSource : `[`Message`](../-message/index.md)`, `[`MessageMetadata`](../-message-metadata/index.md)`, `[`ConstrainSingle`](./index.md)`<`[`MessageSource`](../-message-source/index.md)`>` |
