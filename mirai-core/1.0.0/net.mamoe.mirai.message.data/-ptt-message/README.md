[mirai-core](../../index.md) / [net.mamoe.mirai.message.data](../index.md) / [PttMessage](./index.md)

# PttMessage

`abstract class PttMessage : `[`MessageContent`](../-message-content.md)
...
| Name | Summary |
|---|---|
| [Key](-key/index.md) | `companion object Key : Key<`[`PttMessage`](./index.md)`>` |

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | 需要通过上传到服务器的消息，如语音、文件`PttMessage()` |

### Properties

| Name | Summary |
|---|---|
| [fileName](file-name.md) | `abstract val fileName: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html) |
| [md5](md5.md) | `abstract val md5: `[`ByteArray`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-byte-array/index.html) |
...
| Name | Summary |
|---|---|
| [Voice](../-voice/index.md) | 语音消息, 目前只支持接收和转发`class Voice : `[`PttMessage`](./index.md) |
